...
- 🤝 **[LinkedIn Candidate Recommendation](https://github.com/ThatMajd/LinkedIn_Candidate_Recommendation)** - A **Databricks** and **PySpark** powered recommendation engine that leverages RAG and collaborative filtering to match recruiters' natural language prompts with optimal candidate profiles.
...
- ⚙️ **[EduSat](https://github.com/ThatMajd/edusat)** - SAT solver extension written in **C++** that adds native support for Pseudo-Boolean constraints, featuring custom parsing and conflict-driven clause learning (CDCL) optimizations.
- 🎛️ **[PySerum](https://github.com/ThatMajd/PySerum)** - A **Python** DSL for programmatically generating **Xfer Serum** synthesizer presets, allowing for complex, algorthmic sound design and automation of oscillators, filters, and modulation matrices.
- 🚨 **[homebridge-RedAlert](https://github.com/ThatMajd/homebridge-RedAlert)** - An integration for HomeBridge that polls real-time emergency alerts and triggers automated smart home responses through HomeKit (lights/blinds) during Red Alert events.
